(function () {
  ...
  var DICT = {
    en: {
      ...
      /* Model Compare page */
      'cmp.title':              'Model Compare',
      'cmp.subtitle':           'Run the same request against two LLM backends — diff cost, speed, and output artifacts.',
      'cmp.new':                '+ New Compare',
      'cmp.all':                '← All Compares',
      'cmp.empty':              'No compares yet. Click "+ New Compare" to run a model diff.',
      'cmp.form.title':         'New Model Compare',
      'cmp.form.subtitle':      'Runs the same request in parallel against two backends and diffs the output artifacts.',
      'cmp.form.team':          'Team',
      'cmp.form.request':       'Request',
      'cmp.form.goal':          'Goal',
      'cmp.form.maxcost':       'Max Cost USD (optional)',
      'cmp.form.run':           'Run Compare',
      'cmp.form.running':       'Launching…',
      'cmp.form.cancel':        'Cancel',
      'cmp.col.id':             'ID',
      'cmp.col.request':        'Request',
      'cmp.col.team':           'Team',
      'cmp.col.models':         'Models',
      'cmp.col.status':         'Status',
      'cmp.col.created':        'Created',
      'cmp.polling':            'Polling for results every 3 s…',

      /* Webhooks page */
      'whk.title':              'Webhook Management',
      'whk.subtitle':           'Register and manage per-workspace webhook URLs',
      'whk.workspace':          'Workspace:',
      'whk.registered':         'Registered webhooks',
      'whk.register':           '+ Register',
      'whk.empty':              'No webhooks registered for this workspace.',
      'whk.col.url':            'URL',
      'whk.col.events':         'Events',
      'whk.col.label':          'Label',
      'whk.col.status':         'Status',
      'whk.col.created':        'Created',
      'whk.delete':             'Delete',
      'whk.modal.title':        'Register Webhook',
      'whk.modal.url':          'URL',
      'whk.modal.https':        'Must start with https://',
      'whk.modal.events':       'Event types',
      'whk.modal.label':        'Label',
      'whk.modal.optional':     '(optional)',
      'whk.modal.cancel':       'Cancel',
      'whk.modal.register':     'Register',
      'whk.modal.registering':  'Registering…',

      /* evals regression extra */
      'evals.regression.batch':          'New Regression Batch',
      'evals.regression.run_ids':        'Run IDs (one per line)',
      'evals.regression.team_override':  'Team override',
      'evals.regression.model_override': 'Model override',
      'evals.regression.run':            'Run Regression',
      'evals.regression.running':        'Launching…',
      'evals.regression.empty':          'Results appear here after a regression run.',
    ...
    es: {
      ...
      'cmp.subtitle':           'Ejecuta la misma solicitud contra dos modelos LLM — diferencia coste, velocidad y artefactos.',
      'cmp.new':                '+ Nueva Comparación',
      'cmp.all':                '← Todas las comparaciones',
      'cmp.empty':              'Sin comparaciones. Haz clic en "+ Nueva Comparación" para empezar.',
      'cmp.form.title':         'Nueva Comparación de Modelos',
      'cmp.form.subtitle':      'Ejecuta la misma solicitud en paralelo contra dos modelos y compara los artefactos.',
      'cmp.form.team':          'Equipo',
      'cmp.form.request':       'Solicitud',
      'cmp.form.goal':          'Objetivo',
      'cmp.form.maxcost':       'Costo máximo USD (opcional)',
      'cmp.form.run':           'Ejecutar Comparación',
      'cmp.form.running':       'Iniciando…',
      'cmp.form.cancel':        'Cancelar',
      'cmp.col.id':             'ID',
      'cmp.col.request':        'Solicitud',
      'cmp.col.team':           'Equipo',
      'cmp.col.models':         'Modelos',
      'cmp.col.status':         'Estado',
      'cmp.col.created':        'Creado',
      'cmp.polling':            'Actualizando cada 3 s…',

      /* Webhooks page */
      'whk.title':              'Gestión de Webhooks',
      'whk.subtitle':           'Registra y gestiona URLs de webhook por workspace',
      'whk.workspace':          'Workspace:',
      'whk.registered':         'Webhooks registrados',
      'whk.register':           '+ Registrar',
      'whk.empty':              'No hay webhooks registrados para este workspace.',
      'whk.col.url':            'URL',
      'whk.col.events':         'Eventos',
      'whk.col.label':          'Etiqueta',
      'whk.col.status':         'Estado',
      'whk.col.created':        'Creado',
      'whk.delete':             'Eliminar',
      'whk.modal.title':        'Registrar Webhook',
      'whk.modal.url':          'URL',
      'whk.modal.https':        'Debe comenzar con https://',
      'whk.modal.events':       'Tipos de evento',
      'whk.modal.label':        'Etiqueta',
      'whk.modal.optional':     '(opcional)',
      'whk.modal.cancel':       'Cancelar',
      'whk.modal.register':     'Registrar',
      'whk.modal.registering':  'Registrando…',

      /* evals regression extra */
      'evals.regression.batch':          'Nuevo Lote de Regresión',
      'evals.regression.run_ids':        'IDs de ejecución (uno por línea)',
      'evals.regression.team_override':  'Equipo (override)',
      'evals.regression.model_override': 'Modelo (override)',
      'evals.regression.run':            'Ejecutar Regresión',
      'evals.regression.running':        'Iniciando…',
      'evals.regression.empty':          'Los resultados aparecen aquí tras una ejecución de regresión.',
