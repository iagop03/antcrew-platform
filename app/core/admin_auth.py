...
async def get_session_user(
    ...
    """Return the authenticated User from session cookie, or raise 401.

    Unlike require_platform_admin, does NOT check is_platform_admin.
    """
    raw_token: str | None = request.cookies.get("antcrew_session")
    if not raw_token:
