...
async def dispatch(
    ...
    *,
    ...
    if _github_installation_id is not None and repo_url:
        try:
            from app.services.github_tokens import get_installation_token as _get_inst_token
            ...
            log.warning("runner: could not get GitHub installation token (%s) — falling back to repo_token", _exc)
            ...
            if write_back and _tmp_repo_dir is not None:
                ...
                try:
                    await _do_write_back(
                        result, _tmp_repo_dir, _run_id, repo_url or "",
